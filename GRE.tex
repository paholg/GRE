...
Electric field\begin{equation}\frac{J}{c-m}\end{equation}
...
\\
{\bf{Energy in a Capacitor}}\begin{equation}U = \frac{1}{2}CV^2\end{equation}
\begin{equation}C = k\epsilon_0 \frac{A}{d} = \frac{Q}{V}\end{equation}\\
A = area of capacitor, d = distance between plates, k = relative dielectric constant, k = 1 for free space.\\
\\
\begin{equation}\vec{E} = \frac{V}{d}\end{equation}
{\bf{Capacitors in series}}\begin{equation}C = \frac{1}{{\frac{1}{C_1}+\frac{1}{C_2}+...}}\end{equation}
{\bf{2 Capacitors in series}}\begin{equation}C = \frac{C_1C_2}{C_1+C_2}\end{equation}
...
\\
{\bf{Adiabatic}}:fast processes, no heat loss, ex: diesel engines.\begin{equation}PV^{\gamma} = constant\end{equation}
$\Rightarrow$ where $\gamma$ = $\frac{5}{3}$ for a monotomic ideal gas\\
\\
{\bf{Isothermal}}:slow process, no temperature change.\begin{equation}PV = constant\end{equation}
\\
n dimenisons $\rightarrow$ 2n degrees of freedom
...
\section{Ray Optics}
{\bf{Thin Lens equation}}\begin{equation}\frac{1}{f} = \frac{1}{d_i}+\frac{1}{d_o}\end{equation}\\
{\bf{Cartesian Convention}}\\
1.All figures are drawn with light traveling from left to right.\\
2.All distances are measured from a reference surface, such as a wavefront or a refracting surface. Distances to the left of the surface are negative.\\
...
\\
What this means is that if, for example, the object is on the right side of a lens, the thin lens equation becomes: \begin{equation}\frac{1}{d_i} = \frac{1}{d_o}+\frac{1}{f}\end{equation}\\
\\
{\bf{Raleigh Criterion}} \begin{equation} \theta = \frac{1.22 \lambda}{D} \end{equation}
